export default {
  ...
  Author: '𝒙𝒊𝒂𝒐',
  // 作者头像
  Avatar: 'https://img.tucang.cc/api/image/show/3c036e003432ca50b06a500bed7301b6',
  // 网站座右铭
  Motto: '懒于空想，勤于笔耕；若有所感，方落字成章',
  // Cover 网站缩略图
  Cover: '/assets/images/banner/072c12ec85d2d3b5.webp',
  // 网站侧边栏公告 (不填写即不开启)
  Tips: '<p>欢迎光临我的博客 🎉</p><p>这里会分享我的日常和学习中的收集、整理及总结，希望能对你有所帮助:) 💖</p><img src="http://ip.xiaoh.cc.cd:47903/" alt="ip签名档" style="width:100%;height:auto;border-radius:8px;margin-top:12px;">',
  // 首页打字机文案列表
  TypeWriteList: [
    '笑为光，照岁痕，见未改心',
