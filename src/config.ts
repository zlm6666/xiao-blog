export default {
  ...
  // 网站侧边栏公告 (不填写即不开启)
  Tips: '<p>欢迎光临我的博客 🎉</p><p>这里会分享我的日常和学习中的收集、整理及总结，希望能对你有所帮助:) 💖</p><img src="http://103.236.84.174:47903/" alt="ip签名档" style="width:100%;height:auto;border-radius:8px;margin-top:12px;">',
  // 首页打字机文案列表
  TypeWriteList: [
    '笑为光，照岁痕，见未改心',
